...
extern void CAN_Intrupt_Handler(void) __irq;
#if FIQ
extern void Timr0_Intrupt_FIQHandler(void);
#else
extern void Timr0_Intrupt_Handler(void) __irq;
#endif
extern void Timr1_Intrupt_Handler(void) __irq;
extern void Timr2_Intrupt_Handler(void) __irq;
void init_VIC( void );
